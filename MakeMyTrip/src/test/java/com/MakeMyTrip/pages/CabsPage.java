...
public class CabsPage extends BasePage {
	...
	public boolean inCabs() {
		
		return driver.getCurrentUrl().contains("cabs");
	}
	...
	public void DateSelection(){
		...
		while (!dayVal) {
			for(WebElement mon:month) {
				...
				int comparison = displayedMonthYear.compareTo(travelMonth.toLowerCase());
				if (comparison==0) {
	...
	public boolean Page() {
		...
		return driver.getTitle().contains("Outstation Cabs");
	}
